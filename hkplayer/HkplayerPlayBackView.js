...
const RCT_PLAYER_REF = 'HkplayerPlayBackView';
export default class HkplayerPlayBackView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  executeCommand(command) {
    UIManager.dispatchViewManagerCommand(
      ...
      UIManager.HkplayerPlayBackView.Commands.executeCommand,
      [command],
    );
  }
